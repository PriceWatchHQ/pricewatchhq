export const PLAN_LIMITS = {
  ...
  business: { urls: 500, checkFreqMinutes: 15,   stockCheck: true,  stockFreqMinutes: 15,   smsAlerts: true,  slackAlerts: true,  headlessScraper: true,  playwrightScraper: true  }, // 15 min
};
